...
void calvingDataMap::outputInterbeef603(string psBreed, string psTrait, string categoryInterbeef){
  ...
  if(categoryInterbeef == CONSTANTS::INTERBEEF_CATEGORY_BEEFONBEEF){
    if(psTrait == CONSTANTS::BWT_INTERBEEFTRAIT){
      datafile603 <<"603"<<" "<<psTrait<<" "<<itbBreed<<" "<<"CHE"<<" "<<"99999"<<" "<<"47 "<<" "<<"         5"<<" "<<"N"<<" "<<"Y"<<" "<<"Y"<<" "<<"M"<<" "<<" 10"<<" "<<"HY                   R"<<" "<<"AACA                 X"<<" "<<"CSEX                  F"<<" "<<"YSEA                  F"<<" "<<"PAAC                  F"<<" "<<"BRCM                  F"<<" "<<"CASI                  C"<<" "<<"CSEX                  C"<<" "<<"CABI                  C"<<" "<<"CAID                  C"<<endl;
    }
    if(psTrait == CONSTANTS::CAE_INTERBEEFTRAIT){
      datafile603 <<"603"<<" "<<psTrait<<" "<<itbBreed<<" "<<"CHE"<<" "<<"99999"<<" "<<"17 "<<" "<<"         5"<<" "<<"N"<<" "<<"Y"<<" "<<"Y"<<" "<<"M"<<" "<<" 10"<<" "<<"HY                   R"<<" "<<"AACA                 X"<<" "<<"CSEX                  F"<<" "<<"YSEA                  F"<<" "<<"PAAC                  F"<<" "<<"BRCM                  F"<<" "<<"CASI                  C"<<" "<<"CSEX                  C"<<" "<<"CABI                  C"<<" "<<"CAID                  C"<<endl;
    }
  }else{
