...
//    }
  ...
  cout<<"Number of animal record with missing stillbirth: "<<stillbirthint<<endl;
  cout<<"Number of animal record with missing calvingScore or birthweight or gestationLength: "<<traitNotRead<<endl;
